return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<a-b>", "<cmd>CMakeBuild<CR>", { desc = "CMake Build" })
    vim.keymap.set("n", "<a-g>", "<cmd>CMakeGenerate<CR>", { desc = "CMake Generate" })
    vim.keymap.set("n", "<a-w>", "<cmd>CMakeSelectBuildType<CR>", { desc = "Select CMakeBuildType" })
    vim.keymap.set("n", "<a-d>", "<cmd>CMakeDebug<CR>", { desc = "Start debugging CMakeProject" })
  end,
}
